"""Base entity for Sony Blu-ray IR integration."""
...
from .ir_codes import SonyBlurayCode, SonyBlurayCommand

_LOGGER = logging.getLogger(__name__)


class SonyBlurayIrEntity(Entity):
    """Sony Blu-ray IR base entity."""
    ...
    async def _send_command(self, code: SonyBlurayCode) -> None:
        """Send an IR command through the selected emitter."""
        await async_send_command(
            self.hass,
            self._infrared_entity_id,
            SonyBlurayCommand(code),
